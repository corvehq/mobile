        ...
        <>
            ...
            >
                <G clipPath="url(#clip0_62_8978)">
                    ...
                    />
                    <Path
                        d="M10.5 3H3V10.5H10.5V3ZM4.5 4.5H9V9H4.5V4.5ZM7.5 16.5H6V18H7.5V16.5Z"
                        fill={color ? color : "#ffffff"}
                    />
                    <Path
                        d="M10.5 13.5H3V21H10.5V13.5ZM4.5 15H9V19.5H4.5V15ZM16.5 6H18V7.5H16.5V6Z"
                        fill={color ? color : "#ffffff"}
                    />
                    <Path
                        ...
                        fill={color ? color : "#ffffff"}
                    />
                    <Path d="M18 13.5H21V12H18V13.5Z" fill="#ffffff" />
                </G>
                <Defs>
                    <ClipPath id="clip0_62_8978">
