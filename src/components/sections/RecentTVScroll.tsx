...
import { recentTVBill } from "../../data/recentTVBill";

const RecentTVScroll = ({
    ...
    return (
        <View style={styles.benficiariesScroll}>
            ...
            >
                ...
                {recentTVBill.map((recent, index: number) => {
                    return (
                        <Pressable
                        ...
                        >
                            ...
                            >
                                {recent.decoderNumber.slice(0, 8)}...
                            </Text>
                        </Pressable>
                    );
                })}
