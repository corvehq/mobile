...
import { recentAirtimeList } from "../../data/recentAirtimeList";

const RecentAirtimeScroll = () => {
    return (
        <View style={styles.benficiariesScroll}>
            ...
            >
                ...
                {recentAirtimeList.map((recent, index: number) => {
                    return (
                        <Pressable
...
export default RecentAirtimeScroll;
