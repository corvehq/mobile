...
const EditNOKScreen = () => {
    return (
        ...
        >
            <NavigationHeaderBar title="Your Next of Kin" />
                ...
                <View style={settingStyles.settingScreen.screenContent}>
                    <View style={styles.infoContainer}>
                        <Text style={styles.infoContainer.text}>
                            Type in details of your next of kin.
                        </Text>
                    </View>
                    <View style={styles.accountInputContainer}>
                        ...
                        <View style={styles.accountInputContainer.inputDiv}>
                            ...
                            <TextInput
                                placeholder="NOK Email Address"
                                value="larva.code15@gmail.com"
                                style={styles.accountInputContainer.input}
                            />
                        </View>
                        ...
                        <View style={styles.accountInputContainer.inputDiv}>
                            ...
                            <TextInput
                                ...
                                value="#9 NTA Road, Port Harcourt"
                                style={styles.accountInputContainer.input}
                            />
                        </View>
